defmodule EcoSyncBackend.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {DNSCluster, query: Application.get_env(:eco_sync_backend, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: EcoSyncBackend.PubSub},
      # Start a worker by calling: EcoSyncBackend.Worker.start_link(arg)
      # {EcoSyncBackend.Worker, arg},
