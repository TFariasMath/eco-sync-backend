defmodule EcoSyncBackend.Scanner do
  ...
  @patterns %{
    ...
    "Generic API/Secret Key" =>
      ~r/(api[_-]?key|secret[_-]?key|password|auth[_-]?token)[\s:=]+['"]([a-zA-Z0-9]{16,})['"]/i
  }

  @doc """
  Escanea el contenido en busca de secretos expuestos.
  """
  @spec scan_content(String.t()) :: [secret_finding()]
